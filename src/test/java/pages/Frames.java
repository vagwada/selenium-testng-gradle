...
public class Frames {
    ...
    private final String pageUrl = "/frames";
    ...
    public Frames(WebDriver driver, Map<String, String> data) {
        this(driver);
        this.data = data;
    }

    public Frames(WebDriver driver, Map<String, String> data, int timeout) {
        this(driver, data);
     ...
     *
     * @return the Frames class instance.
     */
    public Frames clickElementalSeleniumLink() {
     ...
     * @return the Frames class instance.
     */
    public Frames clickForkMeOnGithubLink() {
     ...
     * @return the Frames class instance.
     */
    public Frames clickNestedFramesLink() {
        nestedFrames.click();
        return this;
    }
     ...
     * @return the Frames class instance.
     */
    public Frames clickNewTemplateButton() {
        newTemplate.click();
        return this;
    }
     ...
     * @return the Frames class instance.
     */
    public Frames verifyPageLoaded() {
