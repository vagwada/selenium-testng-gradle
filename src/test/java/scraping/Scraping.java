...
public class Scraping {
    ...
    static void jumia(){
             ...
             try {
                 Document docVince = Jsoup.connect("https://www.vinceagwada.com/events").userAgent("Mozilla/5.0 (Windows NT 6.1; WOW64; rv:5.0) Gecko/20100101 Firefox/5.0").timeout(0).get();

                 Elements vinceLinks = docVince.select("div.wrap.archive-wrap.opacity");
